...
> Done in a separate R process, via [callr](https://callr.r-lib.org/), to
guarantee it is self-contained.
...
> Use `rmarkdown::render()` to run the code and capture output that you would
...
> Use chunk option comment = "#>" to include the output while retaining
executability.
